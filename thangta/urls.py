...
urlpatterns = [
    ...
    path('tournaments/<int:tournament_id>/round/<int:current_round>/advance/', generate_next_round_all, name='tournament-round-advance'),
    ]